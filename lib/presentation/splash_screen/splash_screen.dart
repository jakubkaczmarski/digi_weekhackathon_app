                                                          ...
                                                          children: [
                                                            ...
                                                            GestureDetector(
                                                                ...
                                                                child: Container(
                                                                    ...
                                                                    child: Text("msg_get_started_by".tr, maxLines: null, textAlign: TextAlign.center, style: AppStyle.textstylepoppinssemibold15.copyWith(fontSize: getFontSize(15), letterSpacing: 0.90)))),
                                                            Padding(
                                                                padding: EdgeInsets.only(
                                                                    top: getVerticalSize(
                                                                        18.00),
                                                                ...
                                                                child:
                                                                    GestureDetector(
                                                                        ...
                                                                        child: Container(
                                                                            ...
                                                                            width: size.width,
                                                                            decoration: BoxDecoration(borderRadius: BorderRadius.circular(getHorizontalSize(6.00)), border: Border.all(color: ColorConstant.lightGreen500, width: getHorizontalSize(2.00))),
                                                                            child: Text("msg_get_started_wit".tr, textAlign: TextAlign.center, style: AppStyle.textstylepoppinssemibold151.copyWith(fontSize: getFontSize(15), letterSpacing: 0.90)))))
                                                          ])))
                                            ])))
                              ]))
                    ]))));
